...
// NewHeader creates a new Header with the specified parameters.
// Parameters are validated before creating the header.
func NewHeader(signature string, version int, rowSize int, skewMs int) (*Header, error) {
	h := &Header{
		signature: signature,
		version:   version,
		rowSize:   rowSize,
